...
Item {
  ...
  function restorePopups(raw) {
    ...
    for (var i = 0; i < entries.length; i++) {
      var entry = entries[i]
      var duration = durationFor(entry.summary, entry.urgency, entry.expireTimeout)
      ...
      ColumnLayout {
        ...
        Repeater {
          ...
          delegate: Item {
            ...
            readonly property real lifetime: service.durationFor(
              cardSlot.summary, cardSlot.urgency, cardSlot.expireTimeout)
